package com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.adapter;
...
import com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.ui.AddEditAlarmActivity;
...
public final class AlarmsAdapter extends RecyclerView.Adapter<AlarmsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(mAccentColor == -1) {
            mAccentColor = ContextCompat.getColor(c, R.color.Patient_Color);
        }
