    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // I need the patient username that is login now to specified what is the message layout will show to him
                // What is the getUsername hold is hold the doctor username that patient click on recycle review
                if (list2.getUsername().equals("PAli")) {
