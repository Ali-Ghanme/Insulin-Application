package com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.util;

import static com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.data.DatabaseHelper.COL_FRI;
import static com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.data.DatabaseHelper.COL_IS_ENABLED;
import static com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.data.DatabaseHelper.COL_LABEL;
import static com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.data.DatabaseHelper.COL_MON;
import static com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.data.DatabaseHelper.COL_SAT;
import static com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.data.DatabaseHelper.COL_SUN;
import static com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.data.DatabaseHelper.COL_THURS;
import static com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.data.DatabaseHelper.COL_TIME;
import static com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.data.DatabaseHelper.COL_TUES;
import static com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.data.DatabaseHelper.COL_WED;
import static com.example.diabestes_care_app.Ui.Patient_all.Sections.Doses.data.DatabaseHelper._ID;
    ...
    public static ArrayList<Alarm> buildAlarmList(Cursor c) {
        ...
        if (c.moveToFirst()){
            do {
                ...
                @SuppressLint("Range") final long id = c.getLong(c.getColumnIndex(_ID));
                @SuppressLint("Range") final long time = c.getLong(c.getColumnIndex(COL_TIME));
                @SuppressLint("Range") final String label = c.getString(c.getColumnIndex(COL_LABEL));
                @SuppressLint("Range") final boolean mon = c.getInt(c.getColumnIndex(COL_MON)) == 1;
                @SuppressLint("Range") final boolean tues = c.getInt(c.getColumnIndex(COL_TUES)) == 1;
                @SuppressLint("Range") final boolean wed = c.getInt(c.getColumnIndex(COL_WED)) == 1;
                @SuppressLint("Range") final boolean thurs = c.getInt(c.getColumnIndex(COL_THURS)) == 1;
                @SuppressLint("Range") final boolean fri = c.getInt(c.getColumnIndex(COL_FRI)) == 1;
                @SuppressLint("Range") final boolean sat = c.getInt(c.getColumnIndex(COL_SAT)) == 1;
                @SuppressLint("Range") final boolean sun = c.getInt(c.getColumnIndex(COL_SUN)) == 1;
                @SuppressLint("Range") final boolean isEnabled = c.getInt(c.getColumnIndex(COL_IS_ENABLED)) == 1;
